...
void FHLSLMaterialTranslator::GetMaterialEnvironment(EShaderPlatform InPlatform, FShaderCompilerEnvironment& OutEnvironment)
{
	...
	{	
		...
		// [caryjwli START] [Add Custom Shading Model C++ PART 2] add macro define
		if (ShadingModels.HasShadingModel(MSM_MyCustomShadingModel))
		{
			OutEnvironment.SetDefine(TEXT("MATERIAL_SHADINGMODEL_MY_CUSTOM_SHADING_MODEL"),TEXT("1"));
			NumSetMaterials++;
		}
		// [caryjwli END] [Add Custom Shading Model C++ PART 2] add macro define
