...
FText FMaterialAttributeDefinitionMap::GetAttributeOverrideForMaterial(const FGuid& AttributeID, UMaterial* Material)
{
	...
	case MP_CustomData0:	
		...
		// [caryjwli START] [Add Custom Shading Model C++ PART 7] give name for customdata in my custom shading model
		CustomPinNames.Add({MSM_MyCustomShadingModel,"MyCustomData0"});
		// [caryjwli END] [Add Custom Shading Model C++ PART 7] give name for customdata in my custom shading model
	...
	case MP_CustomData1:
		...
		// [caryjwli START] [Add Custom Shading Model C++ PART 7] give name for customdata in my custom shading model
		CustomPinNames.Add({MSM_MyCustomShadingModel,"MyCustomData1"});
		// [caryjwli END] [Add Custom Shading Model C++ PART 7] give name for customdata in my custom shading model
