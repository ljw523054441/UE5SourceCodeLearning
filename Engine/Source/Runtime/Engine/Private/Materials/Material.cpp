	...
	bool bIsTranslucencyWritingVelocity)
{
	...
	case MP_CustomData0:
		...
		// [caryjwli START] [Add Custom Shading Model C++ PART 6] add custom shading model
		, MSM_MyCustomShadingModel });
		// [caryjwli END] [Add Custom Shading Model C++ PART 6] add custom shading model
		break;
	case MP_CustomData1:
