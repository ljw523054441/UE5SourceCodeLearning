...
enum EMaterialShadingModel
{
	...
	// [caryjwli START] [Add Custom Shading Model C++ PART 1] add my cumstom shading model
	MSM_MyCustomShadingModel	UMETA(DisplayName="MyCustomShadingModel"),
	// [caryjwli END] [Add Custom Shading Model C++ PART 1] add my cumstom shading model
