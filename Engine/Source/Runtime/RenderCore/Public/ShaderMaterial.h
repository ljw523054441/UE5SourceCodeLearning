...
struct FShaderMaterialPropertyDefines
{
	...
	// [caryjwli START] [Add Custom Shading Model C++ PART 3] add macro
	uint8 MATERIAL_SHADINGMODEL_MY_CUSTOM_SHADING_MODEL : 1;
	// [caryjwli END] [Add Custom Shading Model C++ PART 3] add macro
